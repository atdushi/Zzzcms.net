...
{
    public class SqLiteMany2ManyDao : IMany2ManyLinkDao
    {
                           ...
                           select new Many2ManyLink
                                      {
                                          ...
                                          LinkId = row.Field<string>("Id"),
                                          Direction = (row.Field<string>("Direction") == "0" ? Direction.Forward : Direction.Backward),
                                          UseWidth = false
                                      };
